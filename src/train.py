...
# # =========================================================
# # SAVE BEST PARAMS + ITERATION for use by predict.py
# # =========================================================
...
#     "best_val_ndcg": study.best_value,
#     "best_gap": best_gap,
# }
...
# print("Run predict.py to train the final model and generate the submission.")


# #second best method so far
# import polars as pl
# import lightgbm as lgb
# import numpy as np
# import pandas as pd
...
# Auto-detect cores. LightGBM parallelises tree building across
# threads — on a 16-core compute server this gives ~4x speedup
# vs the old hardcoded num_threads=4.
# Cap at 32: beyond that LightGBM sees diminishing returns from
